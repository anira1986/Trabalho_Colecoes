...
public class GestaoColecaoGibiController implements IController<ColecaoGibi> {
    private final ColecaoGibiDAO colecaoGibiDAO;

    public GestaoColecaoGibiController(ColecaoGibiDAO colecaoGibiDAO) {
    ...
    public void removeEntry(ColecaoGibi colecaoGibi) throws SQLException {
        ...
        if (colecaoGibiDAO.checkIfItemExist(colecaoGibi)) {
            throw new SQLException("Existem itens associados a esta coleção");
        }
